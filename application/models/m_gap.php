...
class M_Gap extends CI_Model {
	...
	//protected $selisih = [0,1,-1,2,-2,3,-3,4,-4];
	// protected $bobot_nilai = [5,4.5,4,3.5,3,2.5,2,1.5,1];
	...
	{
		//echo ' <pre> hitung($data) :' . print_r($data, true) . '</pre>';
		$users =  $data;
		$raw_aspek = [];
	...
	public function gap($arr_aspek, $sub_kriteria_list, $jenis_list)
	{
		$aspek = (Object)[
			'cf' => 0.6,
			'sf' => 0.4,
